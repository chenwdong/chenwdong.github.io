...
SEOTitle:           # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“”** but I want the title shows in search engine is **“黄玄的博客 | ”** which is multi-language.
